...
function mb_wcchpi_settings_field_callback(){
    ...
    <label for="mb-wcchpi-disable-kofi">
        <input id="mb-wcchpi-disable-kofi" type="checkbox" value="1" name="mb-mc-coupon-disable-kofi" <?php checked( get_option( 'mb-mc-coupon-disable-kofi', false ) ); ?>> Disables the Ko-Fi message in the copuons pane
    </label>
    <?php
}
